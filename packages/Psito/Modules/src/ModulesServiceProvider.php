...
namespace Psito\Modules;

use Illuminate\Foundation\AliasLoader;
use Illuminate\Support\ServiceProvider;
use Psito\Support\Stub;
...
class ModulesServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->register('Psito\Modules\Providers\BootstrapServiceProvider');
    }
    ...
    protected function registerHtml()
    {
        ...
        $aliases = [
            ...
            'Module' => 'Psito\Modules\Facades\Module',
        ];
    ...
    protected function registerProviders()
    {
        ...
        $this->app->register('Psito\Modules\Providers\ContractsServiceProvider');
    }
}
