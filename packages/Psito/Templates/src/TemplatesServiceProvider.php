...
class TemplatesServiceProvider extends ViewServiceProvider
{
	/**
	...
	public function register()
	{
		$this->mergeConfigFrom(
			__DIR__.'/../config/templates.php', 'sapling'
		);
	...
	/**
	 * Bind all Templates options to the IoC container for easy access.
	 *
	 * @return null
	 */
	...
	/**
	 * Bind Templates loaders to the IoC container for easy access.
	 *
	 * @return null
	 */
	...
	/**
	 * Bind Templates Twig engine to the IoC container for easy access.
	 *
	 * @return null
	 */
	protected function bindTwigEngine()
	{
		...
		$this->app->alias('sapling.twig', 'Psito\Templates\Twig\Environment');
