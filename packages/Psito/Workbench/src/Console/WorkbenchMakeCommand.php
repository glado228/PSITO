<?php namespace Psito\Workbench\Console;

use Illuminate\Console\Command;
use Psito\Workbench\Package;
use Psito\Workbench\PackageCreator;
...
class WorkbenchMakeCommand extends Command
{
     ...
     *
     * @param  \Psito\Workbench\PackageCreator  $creator
     * @return void
     */
     ...
     *
     * @param  \Psito\Workbench\Package  $package
     * @return string
     */
