...
namespace Psito\Packages\Console\Commands;

use Illuminate\Console\Command;
use Psito\Packages\Helpers\Helper;
...
class NewCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = "packages:new {vendor} {name}";
    ...
    public function handle()
    {
        ...
        $this->helper->replaceAndSave(__DIR__.'/stubs/ServiceProvider.stub', ['{{vendor}}', '{{name}}'], [$cVendor, $cName], $newProvider);
        $bar->advance();
        ...
        $this->helper->replaceAndSave(getcwd().'/app/config/app.php', 'App\Providers\RouteServiceProvider::class,', $appConfigLine);
        $bar->advance();
